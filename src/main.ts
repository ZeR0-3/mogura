...
import { JScene } from "./Scene/JScene";
import { Yyy3 } from "./Scene/MGScene";
import { Test1 } from "./TT";
...
export function main(param: GameMainParameterObject): void {
	...
	// });
	// const test1 = require( "./TT");
	// const JScene = require("")
	const tt = new Yyy3(param);
	// const tt = new JScene(param);
	const scene = tt.scene;
	let time = 100; // 制限時間
	tt.time = time;
	// tt.param = param;
